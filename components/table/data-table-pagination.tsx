...
export function DataTablePagination<TData>({
 ...
 return (
  <div className="flex items-center justify-between flex-col gap-3 sm:flex-row sm:gap-0 px-2">
   <div className="text-muted-foreground flex-1 text-sm">
    {
     t("table_columns_select", {
   ...
   <div className="flex items-center space-x-6 lg:space-x-8 flex-col gap-3 sm:flex-row sm:gap-0">
