"use client";
import { PassportForm } from "@/components/forms/documents/Passport-form";
...
export default function PageUploadModal() {
 ...
 return (
  <ModalDialog
   back
   title={`${t("form_document_up")} (${t("form_document_passport")})`}
...
function ModalBeneficiary({ id }: { id: number }) {
 ...
 return (
  <div className="flex flex-col gap-3">
   ...
   <PassportForm beneficiaryId={beneficiary.id} />
  </div>
 )
}